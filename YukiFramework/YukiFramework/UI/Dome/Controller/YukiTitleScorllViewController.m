//
//  YukiTitleScorllViewController.m
//  YukiFramework
//
...
@interface YukiTitleScorllViewController ()<UIScrollViewDelegate>
...
@implementation YukiTitleScorllViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title                          = @"TitleScrollView";
...
- (TitleScrollView *)titleScroll
{
    ...
    {
        WS(weakSelf)
        _titleScroll                    = [[TitleScrollView alloc] initWithFrame:CGRectMake(0,0, ScreenWidth, 47)  TitleArray:self.titleArr selectedIndex:0 scrollEnable:NO lineEqualWidth:YES isLarger:YES selectColor:[UIColor redColor] defaultColor:[UIColor blackColor] SelectBlock:^(NSInteger index) {
