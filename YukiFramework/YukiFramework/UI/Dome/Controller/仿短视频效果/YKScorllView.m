...
@interface YKScorllView()<UIScrollViewDelegate,UIGestureRecognizerDelegate>{
    NSArray *_dataArray;
}
/**
 显示主播头像的视图
...
-(void)setData{
    ...
    NSInteger index_MY = 1;//我们模拟当前进入的房间是房间列表下标为2
